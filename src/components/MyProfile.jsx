        ...
        <>
            {user ? (
                <div className="myAccount">
                    <div className="profile-container w-full xsm:w-[225px] sm:w-[275px] md:w-[300px] lg:w-[350px] xl:w-[350px] h-auto ">
                        ...
                        <button className="edit-profile-button xsm:w-[80%] sm:w-[80%] md:w-[70%] lg:w-[70%] xl:w-[70%]
                            ...
                            {isEditing ? (
                                ...
                                <div className="flex items-center justify-center">
                                    ...
                                    <span className="ml-0 mr-1">Edit Profile</span>
                                </div>
                            )}
                        </button>
                        ...
                        {isEditing && (
                            <div className="update-profile">
                                ...
                                <label htmlFor="emailConfirmation" className="input-label xsm:text-[12px] sm:text-[14px] md:text-[14px] lg:text-[16px] xl:text-[16px]
                                        xsm:mb-[3px] sm:mb-[3px] md:mb-[5px] lg:mb-[5px] xl:mb-[5px]">Confirm Email to Update</label>
                                <input
                                ...
                                <button className="update-profile-button xsm:w-[80%] sm:w-[80%] md:w-[70%] lg:w-[70%] xl:w-[70%]
                                    ...
                                    <div className="flex items-center justify-center">
                                        ...
                                        <span className="ml-0 mr-1">Update Profile</span>
                                    </div>
                                </button>
                            </div>
                        )}
                ...
                <div className="no-account flex flex-col items-center justify-center">
                    <div className="">
                        <img
                            src="D.Mentor9.PNG"
                            alt="Background"
                            className="no-account-image relative w-[50vw] h-[70vh] opacity-75"
                        />
                    </div>
